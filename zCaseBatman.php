...
<html>
 ...
 <body>
    ...
    <div class="main">
        ...
        <div class="welcome"> Batman Case </div>

        <div class="pageBreak"></div>

        <div class="singleItem"> 
		    <img src="images/cases/batman.png" alt="Batman Case" title="picture" width="400" height="400" class="singleItemImage">
	        <div class='item'>
                <b>Price:</b> $15 <br>
            ...
            <form action="cart.php" id="order" class="itemCart">
                ...
                <input type="hidden" name="NAME" id ="NAME" value="Batman Case">
                <input type="hidden" name="PRICE" id ="PRICE" value="15">
                <input type=hidden name="ID_NUM" value="4565">
