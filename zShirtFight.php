...
<html>
 ...
 <body>
    ...
    <div class="main">
        ...
        <div class="welcome"> Money Fight shirt </div>

        <div class="pageBreak"></div>

        <div class="singleItem"> 
		    <img src="images/shirts/floydConor.png" alt="Money Fight shirt" title="picture" width="400" height="400" class="singleItemImage">
	        <div class='item'>
                <b>Price:</b> $30 <br>
            ...
            <form action="cart.php" id="order" class="itemCart">
                ...
                <input type="hidden" name="NAME" id ="NAME" value="Money Fight shirt">
                <input type="hidden" name="PRICE" id ="PRICE" value="30">
                <input type=hidden name="ID_NUM" value="1012">
